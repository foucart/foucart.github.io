...
\begin{tabular}{ll}
%2025-  & Joint Appointee\\
%& \quad Theoretical Division, Los Alamos National Laboratory\\
...
2021-  & Associate Director of External Academic Engagement, Texas A\&M Institute of Data Science\\
...
\begin{tabular}{ll}
2026 & {\sl Joseph F. Traub Prize} for Achievement in Information-Based Complexity\\
2026 & {\sl Frontiers of Science Award} (with 
I.~Daubechies, R.~DeVore, B.~Hanin, G.~Petrova)\\
2024 & %Recipient of a 
...
\betaremune
\item {\sl Worst-case-optimal estimation of a quadratic form by quadratic functionals of its linear observations.}\\
...
SIAM Journal on Applied Algebra and Geometry, 10/2, 450--466, 2026.
With M.  Dressler, M.  Joldes, E. de Klerk, J.~B. Lasserre,  Y. Xu.
\item {\sl When is a subspace of $\ell_\infty^N$ isometrically isomorphic to $\ell_\infty^n$?}\\
Linear Algebra and its Applications, 733, 171--177, 2026. With B.~Deregowska, B.~Lewandowska. 
...
\betaremune
\item {\sl Worst-case completion of tensors with approximately few ANOVA terms.}\\
In preparation. With J. Shao.
\item {\sl A different perspective on out-of-sample generalization.}\\
Submitted. With T. Winckelman.
\item {\sl Optimal algorithms for nonlinear estimation with convex models.}\\
In revision. Forum of Mathematics, Sigma.
\eetaremune
...
\bitemize 
\item {\sl Optimal estimation of quadratic forms}, 
Special session `Mathematics of Data Science and Machine Learning',
Joint Mathematics Meetings, Chicago,  12-15 Jan 2027.
%\item {\sl TBA},
%Workshop `Mathematics of Data Science',
%Computational Techniques and Applications conference, Sydney, Australia, 8-11 Dec 2026.
\item {\sl  Optimal estimation of quadratic forms},
Workshop on `Complexity Theory in Machine Learning', 
Radon Institute for Computational and Applied
Mathematics (RICAM), Linz, Austria, 30 Nov--4 Dec 2026.
\item {\sl Nonlinear approximation and deep ReLU networks}, International Congress of Basic Science
(for the Frontiers of Science Award),
Beijing, China, 9-21 August 2026.
\item {\sl Estimating nonlinear quantities of interest optimally}, 
Workshop ‘Information-Based Complexity’, Foundations of Computational Mathematics conference, Vienna, Austria, 8-18 Jul 2026.
\item {\sl Application of optimization in constructive approximation: some personal examples},
Workshop `Conic Linear Optimization for Computer-Assisted Proofs', Oberwolfach, Germany, 17-22 May 2026.
\item {\sl TBA}, 
9th International Conference on Computational Harmonic Analysis 2026, Vanderbilt University, Nashville, 18-22 May 2026.
\item {\sl Worst-case learning of adverse quantities of interest}, Minisymposium `Numerical Methods for PDEs under Uncertainty: Propagation, Inference, Optimal Control, and Optimization',
SIAM Conference on Uncertainty Quantification,
Minneapolis, 22-25 Mar 2026.
\item {\sl Model-informed learning of nonlinear quantities of interest},
Minisymposium `Approximation Theory', Joint Mathematics Meetings, Washington, D.C., 4-7 Jan 2026. 
\item {\sl Worst-case learning: the view from optimal recovery},
...
\subsection{Seminars}
\bitemize
\item {\sl Model-informed learning: recent results on Optimal Recovery}.
Center for Nonlinear Studies, Los Alamos National Laboratory, 27 Jul 2026.
...
\bitemize
\item Workshop on `Complexity Theory in Machine Learning', as part of the special semester on `AI in Scientific Computing', Radon Institute for Computational and Applied
Mathematics (RICAM), Linz, Austria, 30 Nov--4 Dec 2026. 
...
%\begin{tabular}{ll}
{\bf PhD students\;}  
& Jingchun Shao (Aug 2026-)\\
& Thomas Winckelman (Aug 2023-)\\
%& Tushar Pandey (Aug 2020-) \\
& Chunyang Liao (Aug 2019-May 2023), now Assi. Prof. at University of Arkansas\\
%then postdoc at UCLA\\
...
\begin{tabular}{ll}
{\bf Graduate RAs} & Jingchun Shao (Aug 2025-Jul 2026)\\
& Tom Needham (Summer 2014), now Asso. Prof. at Florida State\\
...
\item Refereed for 
%the journals
{\sl Numerical Algorithms} (2026; 2023),
{\sl Constructive Approximation} (2026; 2022; 2021; 2018; 2015; 2012; twice in 2010),
{\sl Journal of Fourier Analysis and Applications} (2025; 2024; 2019),
{\sl SIAM Review} (2025),
...
the
{\sl National Science Foundation} (2026, 2021, 2019, 2017),
the
{\sl Natural Sciences and Engineering Research Council of Canada} (2025, 2019),
the
...
2008\phantom{-09} & Co-organizer of the Shanks Workshop {\sl Nonlinear Models in Sampling Theory}\\
& Vanderbilt University\\
