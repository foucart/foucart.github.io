...
\begin{tabular}{ll}
2024 & %Recipient of a 
{\sl Heilbronn Distinguished Visiting Fellowship} (July), Isaac Newton Institute, Cambridge, U.K.\\
2019 & %Recipient of a 
...
Journal of Complexity, to appear. With C. Liao.
...
\betaremune
\item {\sl A survey on minimal projections.}\\
In preparation. With L. Skrzypek.
...
In preparation. With N. Hengartner.
\eetaremune
...
\subsection{Seminars}
\bitemize
\item {\sl TBA}. University of Passau, Germany, 18 Jun 2024.
\item {\sl Worst-case learning from inaccurate data and under multifidelity models}.
